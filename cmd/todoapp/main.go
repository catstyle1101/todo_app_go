...
import (
	...
	statistics_postgres_repository "github.com/catstyle1101/todo_app_go/cmd/internal/features/statistics/repository/postgres"
	statistics_service "github.com/catstyle1101/todo_app_go/cmd/internal/features/statistics/service"
	statistics_transport_http "github.com/catstyle1101/todo_app_go/cmd/internal/features/statistics/transport/http"
	...
	web_fs_repository "github.com/catstyle1101/todo_app_go/cmd/internal/features/web/repository/file_system"
	web_service "github.com/catstyle1101/todo_app_go/cmd/internal/features/web/service"
	web_transport_http "github.com/catstyle1101/todo_app_go/cmd/internal/features/web/transport/http"
	"go.uber.org/zap"

	_ "github.com/catstyle1101/todo_app_go/docs"
)
...
func main() {
	...
	webFSRepository := web_fs_repository.NewWebRepository()
	webService := web_service.NewWebService(webFSRepository)
	...
	httpServer := core_http_server.NewHTTPServer(
		httpServerConfig,
		logger,
		core_http_middleware.CORS(httpServerConfig.AllowedOrigins),
